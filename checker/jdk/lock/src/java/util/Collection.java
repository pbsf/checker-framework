...
public interface Collection<E extends @GuardedByInaccessible Object> extends Iterable<E> {
  ...
  // not true, because map could contain nulls:  AssertParametersNonNull("get(#1)")
   boolean contains(@GuardSatisfied Collection<E> this,Object a1);
  @Override
  Iterator<E> iterator();
  ...
  boolean remove(Object a1);
   public abstract boolean containsAll(@GuardSatisfied Collection<E> this,Collection<?> a1);
  boolean addAll(Collection<? extends E> a1);
  boolean removeAll(Collection<?> a1);
  boolean retainAll(Collection<?> a1);
  void clear();
  @Override
   public abstract boolean equals(@GuardSatisfied Collection<E> this,Object a1);
  @Override
