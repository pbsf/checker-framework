...
public interface Map<K extends @GuardedByInaccessible Object, V extends @GuardedByInaccessible Object> {
  public static interface Entry<K extends Object, V extends Object> {
    ...
    public abstract V setValue(V a1);
     public abstract boolean equals(@GuardSatisfied Entry<K,V> this,Object a1);
   ...
   public abstract boolean containsKey(@GuardSatisfied Map<K,V> this,Object a1);
   public abstract boolean containsValue(@GuardSatisfied Map<K,V> this,Object a1);
  ...
  // annotatied (see ArrayList, LinkedList, HashMap).
   public abstract V get(@GuardSatisfied Map<K,V> this,Object a1);
  ...
  public abstract void clear();
   ...
   public abstract boolean equals(@GuardSatisfied Map<K,V> this,Object a1);
